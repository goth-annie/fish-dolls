...
title: Save Design Reference (English)
description: Full setup guide & API reference for the Save Design save‑data system
---

<div style={{textAlign: 'center'}}>
    <h1>Save Design Reference 📘</h1>
    <p>Version 1.0.0 · Last updated May 25 2025</p>
</div>
...
7. [Identifier‑Based Slots](#7-identifier-based-slots)
...
It separates data into **Shared**, **Slot‑specific**, and **Temporary** categories, generating intuitive entry‑points such as `GameData.Load` and `GameData.Save` for you.
...
Implement partial methods in `Encryptor` or use the built‑in AES+HMAC generator (`Tools ▶ Game Data Manager ▶ Encrypt Settings`).
